...
public class WindowGUI extends JFrame implements ThemeChangerListener {
    ...
    private void showAbout() {
        JOptionPane.showMessageDialog(this, "<html>Just Focus<br/>Version: 3.1.3<br/>Developer: Andrei Dodu<br/>Project webpage: https://github.com/goto-eof/justfocus<br/>License; CC BY-NC-SA 4.0</html>", "About", JOptionPane.INFORMATION_MESSAGE);
    }
